...
%     \hspace*{1.7cm}%
%     \raisebox{0.5cm}{\insertfootnotemark}
%     \parbox[b][2cm]{12cm}{
%         \insertfootnotetext%
%     }%
% }
...
\setbeamercolor{frametitle}{fg=vcuyellow}
\setbeamercolor{local structure}{fg=vcuyellow}
\setbeamercolor{footline}{fg=vcuyellow, bg=white}
\setbeamercolor{titlelike}{fg=vcuyellow}
\setbeamercolor{footnote}{bg=vcuyellow}
\setbeamercolor{normal text}{fg=black}
\setbeamercolor{block title}{fg=vcuyellow, bg=white}
\setbeamercolor{author}{fg=vcuyellow}
\setbeamercolor{institute}{fg=vcuyellow}
\setbeamercolor{date}{fg=vcuyellow}
...
\addtobeamertemplate{footline}{%
  \color{vcuyellow}% to color the progressbar
  \hspace*{-\beamer@leftmargin}%
  \rule{\beamer@leftmargin}{2pt}%
  \rlap{\rule{\dimexpr(\beamer@rightmargin+\textwidth)*\beamer@startpageofframe/\beamer@endpageofdocument}{2pt}}
...
{%
    \includegraphics[width=\paperwidth,height=\paperheight]{style/title.png}%
}
